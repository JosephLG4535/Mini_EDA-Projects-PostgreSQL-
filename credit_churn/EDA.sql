...
-- 1: average age of customers who attrited among 'Male' and 'Female'
--both female and male who attrited have average age of 47
...
--married group has most attrited likely due to reasons like 'financial restructuring', 
...
-- 3: finding the attrited distribution among marital status with different income categories
--all marital status groups share similarities where lowest income show highest attrited,
--highest income show lowest attrited
WITH t1 AS (
